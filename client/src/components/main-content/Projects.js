    ...
    return (
        <div id="Projects">
            <Grid container item direction="column" justify="flex-start" alignItems="center">
                ...
                <SectionItem img={Repopit} title={"Repopit.dev"} internalLink={"/projects/repopit"} position={1}>
                ...
                <h2><SectionHeader headerTitle={"Full Stack"} linkDestination={"/fullstack"} position={2}/></h2>
