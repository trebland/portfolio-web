            ...
            <Grid container item direction="column" justify="flex-start" alignItems="center">
                ...
                <SectionContainer>
                    ...
                    <SectionItem img={Repopit} title={"Repopit.dev"} contributors={["Trevor Bland"]} 
                        technologies={[<><HtmlIcon /><JsIcon /><CssIcon /><ReactIcon /><ReduxIcon /><MaterialUiIcon /></>,<><AwsIcon /></>]} 
                ...
                <SectionContainer>
                    ...
                    <SectionItem img={FocusPocus} title={"Focus Pocus"}
                        ...
                        technologies={[<><HtmlIcon /><JsIcon /><CssIcon /><MongoDbIcon /><ExpressIcon /><ReactIcon /></>,<><NodeJsIcon /><FlutterIcon /><AwsIcon /></>]}
