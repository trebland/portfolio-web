...
const GithubIcon = () => (
  <SvgIcon className="tech-icon"><path d={GITHUB} /></SvgIcon>
)
            ...
            <Grid container item direction="column" justify="flex-start" alignItems="center">
                <SectionItem position={1}>
                    ...
                    <LatestItem projectTitle={"Repopit.dev"} linkDestination={"/projects/repopit"} 
                        projectContributors={"Trevor Bland"} projectTechnologies={<span><HtmlIcon/><CssIcon/><JsIcon/><ReactIcon/><MaterialUiIcon/><GithubIcon/><AwsIcon/></span>} 
